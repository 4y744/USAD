  ...
  return (
   ...
   h-90 md:px-16 px-8 bg-home-headline bg-no-repeat bg-cover aspect-[6]'>
        <div className='flex flex-col justify-center sm:items-start items-center md:w-1/2'>
            <Header text="Universal Scalable Algorithm Directory"/>
            ...
            <a href="#" className="px-4 py-3 my-3 rounded-md bg-green-700 hover:bg-green-600 transition-background duration-100 active:outline outline-offset-2 outline-2 outline-green-600 shadow-md">Get started</a>
        </div>
